...
public interface TypeConverter<T> {
    ...
    /**
     * The corresponding primitive type that can also be handled by the convertor. Simply
     * return null if there is no primitive type for this convertor.
