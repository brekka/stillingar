...
class MapNamespaceContext implements NamespaceContext {
    ...
    public MapNamespaceContext(Map<String, String> nsMap, String defaultNS) {
        ...
        if (defaultNS != null) {
            this.prefixToNamespace.put(XMLConstants.NULL_NS_URI, defaultNS);
            this.namespaceToPrefix.put(defaultNS, Arrays.asList(XMLConstants.NULL_NS_URI));
        }
    }
